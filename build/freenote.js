...
var CN_1 = __webpack_require__(/*! ./CN */ "./code/CN.ts");
var Paper = /** @class */ (function () {
    ...
    Paper.prototype.initWrapHeight_ = function () {
        // 画面の高さ - (topnavi + いろいろマージン）
        var _this = this;
        var wrap = $(CN_1.CN.cssid_wrap_freenote);
        var h_topnav = $(CN_1.CN.cssid_topnav).height();
        ...
        this.clearState();
        // クリーンのハンドラ登録
        $(CN_1.CN.cssid_bt_clean).on("click", function () {
            var wrap = $(CN_1.CN.cssid_wrap_freenote);
            var paperCtx = _this.getContext2D_();
            paperCtx.clearRect(0, 0, wrap.width(), wrap.height());
        });
    };
    Paper.prototype.initWrapWidth_ = function () {
        // 横幅はCSSで自然と最大になるのでそのまま。
        var wrap = $(CN_1.CN.cssid_wrap_freenote);
        wrap.width(wrap.width());
    };
    Paper.prototype.fitWrap = function () {
        var canv = $(CN_1.CN.cssid_freenote);
        var wrap = $(CN_1.CN.cssid_wrap_freenote);
        canv.attr("width", wrap.width());
        canv.attr("height", wrap.height());
    };
    Paper.prototype.getContext2D_ = function () {
        var canv = $(CN_1.CN.cssid_freenote);
        var dCanv = canv[0];
        return dCanv.getContext("2d");
    };
    Paper.prototype.clearState = function () {
        this.preX = null;
        this.preY = null;
    };
    Paper.prototype.draw = function (x, y) {
        var clr = this.getColor_();
        var tool = this.getTool_();
        this.drawProc_(x, y, tool, clr);
    };
    Paper.prototype.drawProc_ = function (x, y, tool, clr) {
    ...
    Paper.prototype.getTool_ = function () {
...
var Sense = /** @class */ (function () {
    function Sense(o_paper) {
        ...
        this.setHandlerTouch_ = function (freenote, elabel) {
            freenote.on(elabel, function (e) {
                e.preventDefault();
                _this.nowdevice = "touch";
                var xy = _this.getXY_(_this.nowdevice, e);
                if (elabel == "touchend") {
                    _this.nowpos = "up";
                }
                ...
                // 現在の位置に従って描画
                if (_this.nowpos == "down") {
                    _this.paper.draw(xy.x, xy.y);
                }
                else {
                    _this.paper.clearState();
                }
            });
        };
        // event handlerのためアロー関数
        this.setHandlerPointer_ = function (freenote, elabel) {
            freenote.on(elabel, function (e) {
                e.preventDefault();
                _this.nowdevice = "pointer";
                var xy = _this.getXY_(_this.nowdevice, e);
                if (elabel == "pointerup") {
                    _this.nowpos = "up";
                }
    ...
    Sense.prototype.setHandler = function () {
        var freenote = $(CN_1.CN.cssid_freenote);
    ...
    // event handlerのためアロー関数
    Sense.prototype.setHandlerMouse_ = function (freenote, elabel) {
        var _this = this;
        freenote.on(elabel, function (e) {
            // タッチが先に検知されるので優先する。
            if (_this.nowdevice != "touch") {
                _this.nowdevice = "mouse";
                var xy = _this.getXY_(_this.nowdevice, e);
                // 位置の更新
                if (elabel == "mouseup") {
                    _this.nowpos = "up";
            ...
            // 次に、マウスイベントが拾えるように。 
            _this.nowdevice = null;
        });
    };
    Sense.prototype.getXY_ = function (dev, e) {
        if (dev == "touch") {
            var te = e.originalEvent;
            var oe = te.changedTouches[0];
...
Object.defineProperty(exports, "__esModule", { value: true });
var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
var Paper_1 = __webpack_require__(/*! ./Paper */ "./code/Paper.ts");
var Sense_1 = __webpack_require__(/*! ./Sense */ "./code/Sense.ts");
$(function () {
    var p = new Paper_1.Paper();
    var s = new Sense_1.Sense(p);
    s.setHandler();
});
...
module.exports = __webpack_require__(/*! ./code/main.ts */"./code/main.ts");


/***/ })

/******/ });
//# sourceMappingURL=freenote.js.map